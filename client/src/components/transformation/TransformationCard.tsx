        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <div className="relative h-40 w-full rounded-md overflow-hidden bg-gray-100">
              <img className="w-full h-full object-cover" src={originalImageUrl} alt="Original photo" />
            </div>
          </div>
          {/* Transformed image */}
          <div>
            ...
            <div className="relative h-40 w-full rounded-md overflow-hidden bg-gray-100">
              <img className="w-full h-full object-cover" src={transformedImageUrl} alt="AI transformed photo" />
            </div>
          </div>
        </div>
        <div className="mt-3">
